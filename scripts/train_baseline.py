"""
Phase 1: Train a baseline CIFAR-10 model and export detector calibration + serving bundle.
"""
...
def main() -> None:
    ...
    p.add_argument("--out", type=str, default="./artifacts/baseline_bundle.pt")
    ...
    save_serving_bundle(
        ...
        model.cpu(),
        det_state,
        meta={"kind": "baseline", "model_version": "1.0.0", "epochs": args.epochs, "test_acc": final_acc},
    )
    print(f"Saved bundle to {Path(args.out).resolve()}")
